package com.zhousaito.subtitleview;
...
/**
 * Created by zhousaito on 2018/5/8.
 */
...
public class SubTitleView extends RelativeLayout {
    ...
    public SubTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rightTextColor = a.getColor(R.styleable.SubTitleView_rightTextColor, context.getResources().getColor(R.color.lan));
